...
# - Assume Python 3.x
#
# Modified by PolyCat to default to ghostty term
...
class OpenTerminalExtension(Nautilus.MenuProvider, GObject.GObject):
    ...
    def _open_terminal(self, file):
        ...
        if 'ghostty' in exc or 'terminator' in exc:
    ...
    def _get_terminal_exec(self):
        ...
        configuration, or ghostty if nothing else has been specified.
        """
